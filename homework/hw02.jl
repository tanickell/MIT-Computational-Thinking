...
# ╔═╡ 88a8e2a0-28d3-4610-9bd9-8ad170d61755
function my_sum(xs)
...
# 	v_blur = copy(v)
# 	for i in 1:length(v)
# 		v_blur[i] = mean(extend.(v[i-l:i+l], i-l:i+l))
# 	end
# 	return v_blur
# end
...
manifest_format = "2.0"
project_hash = "022364cc80cb586381d8dc2e5751db5e30ced660"
